...
COPY --from=builder --chown=appuser:appuser /app/target/release/mcp-exec /usr/local/bin/
...
LABEL org.opencontainers.image.source="https://github.com/timasoft/mcp-exec"
